...
> **Note:** Canonical agent instructions now live in `CLAUDE.md`. This file is kept for quick reference on operations, release workflows, and specific troubleshooting.
